...
## Troubleshooting
If you run into any issues running this code, please contact me (Patrick Berne) over Webex. As a note: encoding takes *awhile*. I would recommend using 4-8 threads and leaving your computer running for up to an hour while the code generates the dictionary.
